...
typedef void (^DLRouteDirectionsWeakSelfWithResponse)(NSError * error, NSDictionary * routeDistance, NSDictionary * routeDuration , MKPolyline * routePolyline, NSArray * routes, NSArray * steps, CLLocation * startPoint, CLLocation * endPoint, NSArray * directions);


typedef void (^DLAddressValidationObjectWeakSelfWithResponse)(NSError * error, NSString * addressStatus, NSArray * formattedAddress, NSArray * addressesGPSLocations);




@interface DLRouteDirections : NSObject
// routing...
...
/****************************************************************************
OUTPUT
 DLAddressValidationObjectWeakSelfWithResponse:
