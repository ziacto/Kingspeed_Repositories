...
{
    if (_frmt) {
        NSLog(@"%@: %@",_frmt,[self stringFromDateWithFormat:STRING_FROM_DATE andTimeZone:timeZone]);
    }
    else {
        NSLog(@"%@",[self stringFromDateWithFormat:STRING_FROM_DATE andTimeZone:timeZone]);
    }
}
// TuanDV
