...
@interface FacebookView : UIViewController<UITextViewDelegate, UIAlertViewDelegate>
{
    IBOutlet UITextViewPerformAction *_txvContentPost;
    NSMutableArray *_imagesPathForPost;
}

@property (nonatomic, strong) NSMutableArray *imagesPathForPost;
