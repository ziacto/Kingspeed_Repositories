...
+ (MBProgressHUD *)showHUDAddedToWindowWithTitle:(NSString *)title animated:(BOOL)animated
{
...
+ (NSUInteger)hideAllHUDForWindowAnimated:(BOOL)animated
{
    return [MBProgressHUD hideAllHUDsForView:[[UIApplication sharedApplication] delegate].window animated:animated];
}
