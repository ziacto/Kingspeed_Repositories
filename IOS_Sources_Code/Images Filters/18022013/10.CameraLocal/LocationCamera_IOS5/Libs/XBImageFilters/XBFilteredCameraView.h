...
@property (strong, nonatomic) IBOutlet id<XBFilteredCameraViewDelegate> delegate;
...
- (void)takeAPhotoWithCompletion:(void (^)(UIImage *image, XBPhotoOrientation processWithOrient))completion;
