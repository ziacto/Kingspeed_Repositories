...
// 中央判定のoffset値.
#define DPMENU_THRESHOLD_CENTER	(0.5f)
#define DPMENU_THRESHOLD_ALPHA	(0.3f)
...
typedef enum
{
	...
	// based on iCarouselTypeWheel, by whogot.
	iCarouselTypeDPointMenuA,
	iCarouselTypeDPointMenuB,
	iCarouselTypeDPointMenuC,
	iCarouselTypeDPointMenuD,
	iCarouselTypeCustom
}
iCarouselType;
