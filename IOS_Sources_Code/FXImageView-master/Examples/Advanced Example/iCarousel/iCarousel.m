...
{   
    ...
    switch (_type)
    {
        ...
        {
            if ([_delegate respondsToSelector:@selector(carousel:itemTransformForOffset:baseTransform:atIndex:)])
            {
                return [_delegate carousel:self itemTransformForOffset:offset baseTransform:transform atIndex:index];
            }
