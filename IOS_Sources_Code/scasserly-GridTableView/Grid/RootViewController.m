...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        cell = [[[GridTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier column:5] autorelease];
    ...
    for (int i = 0; i < [cell columnCount]; i++) {
        [[cell cellAtColumn:i] setText:[NSString stringWithFormat:@"Row:%i Col:%i",indexPath.row,i]];
    }
